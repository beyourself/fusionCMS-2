...
class Update
{
	...
	private static function getPassword()
	{
		...
		else
		{
			if(!is_writable("./"))
			{
				die('The updates/ folder is not writable. Please see <a href="http://raxezdev.zendesk.com/entries/22839206-File-permissions-Installation-problems-fopen-permission-denied-" target="_blank">the FAQ</a> for more information.');
			}
