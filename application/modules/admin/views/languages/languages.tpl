<section class="box big" id="main_link">
	...
	<span>
		<center><b>Want more?</b> Get more languages from the <a href="http://github.com/raxezdev/FusionCMS-Localization" target="_blank">localization GitHub repository</a></center>
	</span>
</section>