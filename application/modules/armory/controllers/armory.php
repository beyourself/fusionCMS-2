...
class Armory extends MX_Controller
{
	...
	private function getIcon($id, $realm)
	{
		...
		if($cache !== false)
		{
			...
			if($cache2 != false)
			{
				return '<img src="http://wow.zamimg.com/images/wow/icons/small/'.$cache2.'.jpg" align="absmiddle" />';
			}
			else
			{
				return '<img src="http://wow.zamimg.com/images/wow/icons/small/inv_misc_questionmark.jpg" align="absmiddle" />';
			}
		}
		else
		{
