	 ...
	 getIcon: function(id, realm, slot)
	 {
	 	if($.inArray(id, this.loadedIcons) == -1)
	 	{
	 		...
	 		$.get(Config.URL + "icon/get/" + realm + "/" + id, function(data)
		 	{
		 		...
		 		{
		 			$(this).html("<div class='item'><a href='" + Config.URL + "item/" + realm + "/" + id + "' "+(Config.UseFusionTooltip ? 'rel-e' : 'rel')+"='item=" + id + "' data-item-slot='" + slot + "'  data-realm='" + realm + "'></a><img src='http://wow.zamimg.com/images/wow/icons/large/" + data + ".jpg' /></div>");
