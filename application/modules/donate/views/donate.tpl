<div id="donate">
	{if $donate_paypal.use || 
		...
		<section id="paypal_area" style="display:none;">
			<form action="http://www{if $donate_paypal.sandbox}.sandbox{/if}.paypal.com/cgi-bin/webscr" method="post" class="page_form">
		...
		<section id="paymentwall_area" style="display:none;">
			<div id="donate">
				<iframe
					src="http://wallapi.com/api/ps/?key={$donate_paymentwall.key}&uid={$user_id}&widget={$donate_paymentwall.widget_code}"
					width="90%"
