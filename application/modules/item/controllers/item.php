...
class Item extends MX_Controller
{
	...
	private function getIcon($id)
	{
		...
		if($cache !== false)
		{
			...
			if($cache2 != false)
			{
				return "<div class='item'><a></a><img src='http://wow.zamimg.com/images/wow/icons/large/".$cache2.".jpg' /></div>";
			}
			else
			{
				return "<div class='item'><a></a><img src='http://wow.zamimg.com/images/wow/icons/large/inv_misc_questionmark.jpg' /></div>";
			}
		}
		else
		{
