...
[![Stable release](http://poser.pugx.org/phpspec/prophecy/version.svg)](http://packagist.org/packages/phpspec/prophecy)
[![Build Status](http://travis-ci.org/phpspec/prophecy.svg?branch=master)](http://travis-ci.org/phpspec/prophecy)
