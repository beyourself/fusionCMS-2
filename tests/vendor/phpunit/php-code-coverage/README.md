[![Latest Stable Version](http://poser.pugx.org/phpunit/php-code-coverage/v/stable.png)](http://packagist.org/packages/phpunit/php-code-coverage)
[![Build Status](http://travis-ci.org/sebastianbergmann/php-code-coverage.svg?branch=master)](http://travis-ci.org/sebastianbergmann/php-code-coverage)
