...
[![Latest Stable Version](http://poser.pugx.org/sebastian/environment/v/stable.png)](http://packagist.org/packages/sebastian/environment)
[![Build Status](http://travis-ci.org/sebastianbergmann/environment.png?branch=master)](http://travis-ci.org/sebastianbergmann/environment)
